...
import { changePassword, updateUsername, uploadProfileImage } from "../../services/authApi";
...
export default function Account() {
    ...
    const handleUpdateProfile = async (e) => {
        ...
        setLoading(true);
        try {
            const data = await updateUsername(user.user_id, profileForm.username, user.token);
            if (data.success) {
    ...
    }, [statusUpdate, prevDetectingCount, detectingCameras, cameraList]);
                            ...
                            <div className="flex items-center gap-6">
                                <div className="relative">
                                    {user?.profile_image && user.profile_image !== "null" ? (
                                        <img src={`${API_BASE_URL}/uploads/user_profile/${user.profile_image}`} alt="profile"
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <div
                                            ...
                                            {user?.profile_image && user.profile_image !== "null" ? (
                                                <div className="relative">
                                                    <img src={`${API_BASE_URL}/uploads/user_profile/${user.profile_image}`} 
                                                        alt="profile"
