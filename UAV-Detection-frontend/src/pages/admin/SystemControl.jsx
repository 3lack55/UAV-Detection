...
export default function SystemControl() {
    ...
    const { toasts } = useThreatDetection(statusUpdate, cameraList);
        ...
        <>
            <style dangerouslySetInnerHTML={{
                __html: `
                    ...
                    .ul-stat-label { font-size: 11px; color: #64748b; margin-bottom: 4px; letter-spacing: 0.04em; text-transform: uppercase; }
